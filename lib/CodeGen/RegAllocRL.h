...
#ifndef LLVM_LIB_CODEGEN_REGALLOCRL_H
#define LLVM_LIB_CODEGEN_REGALLOCRL_H
...
protected:
  ...
  static QTable g;
  QLearner *learn = nullptr;
  GreedyQ *q = nullptr;
  RandomPolicy r;
  EpsilonPolicy *policy = nullptr;
  ...
  int calculateReward(unsigned action, float weight);
